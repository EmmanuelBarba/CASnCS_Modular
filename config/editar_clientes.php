...
<body>
	<div class="positioner">
		<!-- SOCIAL  -->
		<div class="menu">
			<?php echo "<div class='menu-title'><p>Cliente: $id</p></div>"; ?>
	...
	<center>
		<section class="registro">
			<br><br>
			<center>
				<form class="form-register" method="POST" action="editar_cliente.php">
					<br>
					<h2>Editar Cliente:</h2>
					<h3> ID Cliente: <?php echo $cliente->id_clientes ?> </h3><br>

					<div>
						<label class="form-label">Nombre:</label>
						<input type="text" name="nombre" class="form-control" placeholder="Nombre cliente" value="<?php echo $cliente->nombre_cliente ?>" required>
					</div>

					<div>
						<label class="form-label">Domicilio:</label>
						<input type="text" name="domicilio" class="form-control" placeholder="Domicilio" value="<?php echo $cliente->domicilio_cliente ?>" required>
					</div>

					<div>
						<label class="form-label">Correo:</label>
						<input type="text" name="correo" class="form-control" placeholder="Correo" value="<?php echo $cliente->correo_cliente ?>" required>
					</div>

					<div>
						<label class="form-label">Telefono:</label>
						<input type="tel" name="telefono" class="form-control" placeholder="Telefono" value="<?php echo $cliente->tel_cliente ?>" required>
					</div>
					...
					<br><br>
					<td colspan="2"><input type="submit" value="ACTUALIZAR CLIENTE" style="display: block; margin: 0 auto"></td><br>
...
<style>
	body {
		...
		background-image: linear-gradient(to top, rgba(0, 0, 0, 0.77) 30%, hsla(0, 100%, 47.1%, 0.36) 50%), url("https://mod2021cas.s3.us-west-1.amazonaws.com/C%26CS/Images/Fondos/img+(43).webp");
